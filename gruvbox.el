...
(defmacro gruvbox-deftheme (name description palette &rest body)
  `(autothemer-deftheme
    ...
    ((default                                   (:background gruvbox-bg :foreground gruvbox-light1))
     ...
     (diff-refine-added                         (:background nil :foreground gruvbox-bright_green :background gruvbox-dark1))
     (diff-removed                              (:background nil :foreground gruvbox-neutral_red))
     (diff-refine-removed                       (:background nil :foreground gruvbox-bright_red  :background gruvbox-dark1))
     ...
     (magit-diff-context-highlight              (:background gruvbox-dark0_soft :foreground gruvbox-light0))
